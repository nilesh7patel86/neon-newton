...
public class ZipViewExtension implements ViewExtension {
    ...
    public Node getView() {
        ...
        Label structureDesc = new Label(
                "This plugin is loaded from a ZIP file containing:\n/classes - internal classes\n/lib - external dependencies");
    ...
    public String getDescription() {
        return "ZIP file structure demonstration";
    }

    @Override
    public String getKeywords() {
        return "zip,archive,utilities,commons,lang";
    }
}
